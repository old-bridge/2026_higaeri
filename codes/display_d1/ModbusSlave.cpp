...
ModbusSlaveBase::ModbusSlaveBase(HardwareSerial& serial, uint8_t slaveId, uint8_t dePin, uint8_t rxPin, uint8_t txPin)
  : serial_(&serial), slaveId_(slaveId), dePin_(dePin), rxPin_(rxPin), txPin_(txPin) {}
